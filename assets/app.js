$(document).ready(function() {
	...
	var portfolioImages = [
		...
		},
		{
			...
			description:
				'Employee Portal for an electrical contracting company, with features such as daily schedule and timesheet reporting. Developed in React as a CRUD App based on MongoDB Stitch / Atlas',
			file: 'deerfield.jpg',
			type: 'web'
		}
	];
